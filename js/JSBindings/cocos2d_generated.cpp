...
void S_CCSequence::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCSequence::jscreate, 1, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
void S_CCRotateBy::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCRotateBy::jscreate, 2, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
JSBool S_CCRotateBy::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
	if (argc == 2) {
		double arg0;
		double arg1;
		JS_ConvertArguments(cx, 2, JS_ARGV(cx, vp), "dd", &arg0, &arg1);
		CCRotateBy* ret = CCRotateBy::create(arg0, arg1);
		if (ret == NULL) {
			JS_SET_RVAL(cx, vp, JSVAL_NULL);
			return JS_TRUE;
		}
		do {
			...
			pointerShell_t *pt = (pointerShell_t *)JS_malloc(cx, sizeof(pointerShell_t));
			pt->flags = 0;//FIXME: why? kPointerTemporary;
			pt->data = (void *)ret;
			JS_SetPrivate(tmp, pt);
			JS_SET_RVAL(cx, vp, OBJECT_TO_JSVAL(tmp));
		} while (0);
...
void S_CCEaseExponentialOut::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCEaseExponentialOut::jscreate, 1, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
JSBool S_CCEaseExponentialOut::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
	if (argc == 1) {
		JSObject *arg0;
		JS_ConvertArguments(cx, 1, JS_ARGV(cx, vp), "o", &arg0);
		CCActionInterval* narg0; JSGET_PTRSHELL(CCActionInterval, narg0, arg0);
		CCEaseExponentialOut* ret = CCEaseExponentialOut::create(narg0);
		if (ret == NULL) {
			JS_SET_RVAL(cx, vp, JSVAL_NULL);
			return JS_TRUE;
		}
...
void S_CCEaseSineOut::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCEaseSineOut::jscreate, 1, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
JSBool S_CCEaseSineOut::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
	if (argc == 1) {
		JSObject *arg0;
		JS_ConvertArguments(cx, 1, JS_ARGV(cx, vp), "o", &arg0);
		CCActionInterval* narg0; JSGET_PTRSHELL(CCActionInterval, narg0, arg0);
		CCEaseSineOut* ret = CCEaseSineOut::create(narg0);
		if (ret == NULL) {
			JS_SET_RVAL(cx, vp, JSVAL_NULL);
			return JS_TRUE;
		}
...
void S_CCFadeOut::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCFadeOut::jscreate, 1, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
JSBool S_CCFadeOut::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
	if (argc == 1) {
		double arg0;
		JS_ConvertArguments(cx, 1, JS_ARGV(cx, vp), "d", &arg0);
		CCFadeOut* ret = CCFadeOut::create(arg0);
		if (ret == NULL) {
			JS_SET_RVAL(cx, vp, JSVAL_NULL);
			return JS_TRUE;
		}
...
void S_CCFadeTo::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCFadeTo::jscreate, 2, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
JSBool S_CCFadeTo::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
	if (argc == 2) {
		double arg0;
		unsigned char arg1;
		JS_ConvertArguments(cx, 2, JS_ARGV(cx, vp), "dc", &arg0, &arg1);
		CCFadeTo* ret = CCFadeTo::create(arg0, arg1);
		if (ret == NULL) {
			JS_SET_RVAL(cx, vp, JSVAL_NULL);
			return JS_TRUE;
		}
...
void S_CCBlink::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCBlink::jscreate, 2, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
JSBool S_CCBlink::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
	if (argc == 2) {
		double arg0;
		unsigned int arg1;
		JS_ConvertArguments(cx, 2, JS_ARGV(cx, vp), "di", &arg0, &arg1);
		CCBlink* ret = CCBlink::create(arg0, arg1);
		if (ret == NULL) {
			JS_SET_RVAL(cx, vp, JSVAL_NULL);
			return JS_TRUE;
		}
...
void S_CCScaleBy::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCScaleBy::jscreate, 2, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
JSBool S_CCScaleBy::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
	if (argc == 2) {
		double arg0;
		double arg1;
		JS_ConvertArguments(cx, 2, JS_ARGV(cx, vp), "dd", &arg0, &arg1);
		CCScaleBy* ret = CCScaleBy::create(arg0, arg1);
		if (ret == NULL) {
			JS_SET_RVAL(cx, vp, JSVAL_NULL);
			return JS_TRUE;
		}
...
void S_CCScaleTo::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	...
	jsClass->flags = JSCLASS_HAS_PRIVATE;
		...
		static JSFunctionSpec st_funcs[] = {
			JS_FN("create", S_CCScaleTo::jscreate, 2, JSPROP_PERMANENT | JSPROP_SHARED),
			JS_FS_END
		};
...
JSBool S_CCScaleTo::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
	if (argc == 2) {
		double arg0;
		double arg1;
		JS_ConvertArguments(cx, 2, JS_ARGV(cx, vp), "dd", &arg0, &arg1);
		CCScaleTo* ret = CCScaleTo::create(arg0, arg1);
		if (ret == NULL) {
			JS_SET_RVAL(cx, vp, JSVAL_NULL);
			return JS_TRUE;
		}
...
JSClass* S_CCMenuItemFont::jsClass = NULL;
JSObject* S_CCMenuItemFont::jsObject = NULL;

JSBool S_CCMenuItemFont::jsConstructor(JSContext *cx, uint32_t argc, jsval *vp)
{
    JSObject *obj = JS_NewObject(cx, S_CCMenuItemFont::jsClass, S_CCMenuItemFont::jsObject, NULL);
    S_CCMenuItemFont *cobj = new S_CCMenuItemFont(obj);
    pointerShell_t *pt = (pointerShell_t *)JS_malloc(cx, sizeof(pointerShell_t));
    pt->flags = 0; pt->data = cobj;
    JS_SetPrivate(obj, pt);
    JS_SET_RVAL(cx, vp, OBJECT_TO_JSVAL(obj));
...
void S_CCMenuItemFont::jsFinalize(JSContext *cx, JSObject *obj)
{
	pointerShell_t *pt = (pointerShell_t *)JS_GetPrivate(obj);
	if (pt) {
		if (!(pt->flags & kPointerTemporary) && pt->data) ((S_CCMenuItemFont *)pt->data)->release();
		JS_free(cx, pt);
	}
}

void S_CCMenuItemFont::jsCreateClass(JSContext *cx, JSObject *globalObj, const char *name)
{
	jsClass = (JSClass *)calloc(1, sizeof(JSClass));
	jsClass->name = name;
	jsClass->addProperty = JS_PropertyStub;
...
JSBool S_CCMenuItemFont::jsgetFontSizeObj(JSContext *cx, uint32_t argc, jsval *vp)
{
    if (argc == 0) {
        JSObject* obj = (JSObject *)JS_THIS_OBJECT(cx, vp);
        S_CCMenuItemFont *cobj; JSGET_PTRSHELL(S_CCMenuItemFont, cobj, obj);
        unsigned int size = cobj->fontSizeObj();
        JS_SET_RVAL(cx, vp, UINT_TO_JSVAL(size));
...
JSBool S_CCMenuItemFont::jsgetFontNameObj(JSContext *cx, uint32_t argc, jsval *vp)
{
    if (argc == 0) {
        JSObject* obj = (JSObject *)JS_THIS_OBJECT(cx, vp);
        S_CCMenuItemFont *cobj; JSGET_PTRSHELL(S_CCMenuItemFont, cobj, obj);
        const char *fontName = cobj->fontNameObj();
        JS_SET_RVAL(cx, vp, STRING_TO_JSVAL(JS_InternString(cx, fontName)));
...
JSBool S_CCMenuItemFont::jssetFontNameObj(JSContext *cx, uint32_t argc, jsval *vp)
{
    if (argc == 0) {
        JSString *arg0;
        JS_ConvertArguments(cx, 1, JS_ARGV(cx, vp), "S", &arg0);
...
JSBool S_CCMenuItemFont::jscreate(JSContext *cx, uint32_t argc, jsval *vp) {
    if (argc == 1 || argc == 3) {
        ...
        {
            JS_ConvertArguments(cx, 3, JS_ARGV(cx, vp), "Soo", &arg0, &arg1, &arg2);
            pThisObj = arg1;
            pCallBackObj = arg2;
        }
