...
void Issue1305_2::onEnter()
{
    ...
    */
    ...
    CCCallFunc* act2 = CCCallFunc::create(this, callfunc_selector(Issue1305_2::log01)) ;
    CCMoveBy* act3 = CCMoveBy::create(2, ccp(0, -100));
    CCCallFunc* act4 = CCCallFunc::create(this, callfunc_selector(Issue1305_2::log02)) ;
    CCMoveBy* act5 = CCMoveBy::create(2, ccp(100, -100));
    CCCallFunc* act6 = CCCallFunc::create(this, callfunc_selector(Issue1305_2::log03)) ;
    CCMoveBy* act7 = CCMoveBy::create(2, ccp(-100, 0));
    CCCallFunc* act8 = CCCallFunc::create(this, callfunc_selector(Issue1305_2::log04)) ;
...
void Issue1305_2::log01()
{
    CCLog("1st block");
}

void Issue1305_2::log02()
{
    CCLog("2nd block");
}

void Issue1305_2::log03()
{
    CCLog("3rd block");
}

void Issue1305_2::log04()
{
    CCLog("4th block");
}
